...
yaxiscolors = {'#DC582A','#ADD8E6','#FFC000','#0072BD'};
...
matfilename=sprintf('figure3_c_beta%.2g',beta); 
...
% 
% f3 = (rho3^2 * exp(2 * g3 * B3) .* B3dot).^(beta)./(rho3 * exp(g3*B3) + 1).^(3*beta);
% 
% % f3 = (rho3^2 * exp(2 * g3 * B3) .* B3dot)^(1/4)./(rho3 * exp(g3*B3) + 1).^(2/4);
% 
% % f3 = ( (rho3 * exp(g3*B3) .* B3dot)./(rho3 * exp(g3*B3) + 1).^2 ).^(1/2) ...
% %     .* ( ( rho3 * exp(g3*B3) ) ./( rho3*exp(g3*B3) + 1 ) ).^(1-(1/2));
% 
...
% 
% f1 = (rho1^2 * exp(2 * g1 * B1) .* B1dot).^(beta)./(rho1 * exp(g1*B1) + 1).^(3*beta);
% 
% % f1 = (rho1^2 * exp(2 * g1 * B1) .* B1dot)^(1/4)./(rho1 * exp(g1*B1) + 1).^(2/4);
% 
% % f1 = ( (rho1 * exp(g1*B1) .* B1dot)./(rho1 * exp(g1*B1) + 1).^2 ).^(1/2) ...
% %     .* ( ( rho1 * exp(g1*B1) ) ./( rho1*exp(g1*B1) + 1 ) ).^(1-(1/2));
% 
...
% 
% f2 = (rho2^2 * exp(2 * g2 * B2) .* B2dot).^(beta)./(rho2 * exp(g2*B2) + 1).^(3*beta);
% 
% % f2 = (rho2^2 * exp(2 * g2 * B2) .* B2dot).^(1/4)./(rho2 * exp(g2*B2) + 1).^(2/4);
% 
% % f2 = ( (rho2 * exp(g2*B2) .* B2dot)./(rho2 * exp(g2*B2) + 1).^2 ).^(1/2) ...
% %     .* ( ( rho2 * exp(g2*B2) ) ./( rho2*exp(g2*B2) + 1 ) ).^(1-(1/2));
% 
...
% 
% % f4 = ( (rho4 * exp(g4*B4) .* B4dot)./(rho4 * exp(g4*B4) + 1).^2 ).^(1/2) ...
% %     .* ( ( rho4 * exp(g4*B4) ) ./( rho4*exp(g4*B4) + 1 ) ).^(1-(1/2));
% 
% 
