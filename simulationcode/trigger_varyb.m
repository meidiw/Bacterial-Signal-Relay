...
if test == 1
    for ii = 1:3
        ...
        solfb = pdepe(m,@(r,t,u,dudx)fb_ode(r,t,u,dudx,D,s0,s1,H1,J2,Z2,k,alpha,lambda2,rho2,g2),...
...
if test == 1; saveas(f1,[ dir 'suppfigure_varyb2'],'svg'); end
if test == 2; saveas(f1,[ dir 'suppfigure_varyb4'],'svg'); end
