...
nqs = huang_growth(t,g3,lambda3,rho3);
nfbqs = huang_growth(t,g4,lambda4,rho4);
nfb = huang_growth(t,g2,lambda2,rho2);
ncontrol = huang_growth(t,g1,lambda1,rho1);
...
index = 2; % denotes which case to run, i = [control, PF only, IS only, ISPF]
...
if index == 1; title(sprintf('IS- PF-, Threshold = %.5g',thresh)); end
if index == 2; title(sprintf('IS- PF+, Threshold = %.5g',thresh)); end
if index == 3; title(sprintf('IS+ PF-, Threshold = %.5g',thresh)); end
if index == 4; title(sprintf('IS+ PF+, Threshold = %.5g',thresh)); end
legval = [0.2,0.6,1.8];
...
dir = '../fig/simulation/';
% 
% if index == 1; saveas(f1,[ dir 'figure4b_control-threshold'],'pdf'); end
% if index == 2; saveas(f1,[ dir 'figure4b_pf-threshold'],'pdf'); end
% if index == 3; saveas(f1,[ dir 'figure4b_is-threshold'],'pdf'); end
% if index == 4; saveas(f1,[ dir 'figure4b_ispf-threshold'],'pdf'); end


if index == 1; matfilename=sprintf('figure4b_control_beta-05_threshold%.5g',thresh); end 
if index == 2; matfilename=sprintf('figure4b_pf_beta-05_threshold%.5g',thresh); end 
if index == 3; matfilename=sprintf('figure4b_is_beta-05_threshold%.5g',thresh); end 
if index == 4; matfilename=sprintf('figure4b_ispf_threshold%.5g',thresh); end 
